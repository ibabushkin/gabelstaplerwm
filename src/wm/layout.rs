...
// +-+---+-+
// | |   | | A: left stack, hidden if num_windows <= 2
// |A| B |C| B: master window
// | |   | | C: right stack, hidden if num_windows <= 1
// +-+---+-+
...
impl Layout for DStack {
    fn arrange(&self, num_windows: usize, screen: &ScreenSize)
        ...
        if num_windows == 1 {
            ...
            let slave_height_right = screen.height / num_right_slaves as u16;
